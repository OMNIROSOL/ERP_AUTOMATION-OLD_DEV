...
import { ChevronRight, Check, Settings, Building2 } from 'lucide-react';
import { cn } from '../utils/cn';

const EditSupplierColumnsView = () => {
    ...
    const handleUpdate = () => {
        localStorage.setItem('supplier_column_settings', JSON.stringify(columns));
        ...
        <div className="bg-slate-50 min-h-screen selection:bg-indigo-100 selection:text-indigo-900 font-sans p-8 md:p-12 animate-in fade-in duration-700">
            ...
            <div className="max-w-2xl mx-auto mb-10">
                <div className="flex items-center space-x-2 text-[10px] font-black text-indigo-500 uppercase tracking-[0.2em] mb-4">
                    <span className="cursor-pointer hover:text-indigo-600 transition-colors" onClick={() => navigate('/suppliers')}>Suppliers</span>
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-slate-500 font-medium text-sm">Select which data fields you want to see for Suppliers.</p>
                    </div>
                </div>
            </div>
...
export default EditSupplierColumnsView;
