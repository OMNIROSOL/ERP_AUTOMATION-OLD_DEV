...
const EditPurchaseQuoteColumnsView = () => {
    ...
    const handleUpdate = () => {
        localStorage.setItem('purchase_quote_column_settings', JSON.stringify(columns));
...
export default EditPurchaseQuoteColumnsView;
